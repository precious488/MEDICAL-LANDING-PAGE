<?php
include '../config/config.php'; // Ensure this connects to your database
...
// Update service data when the form is submitted
if (isset($_POST['update_service'])) {
    ...
    if (!empty($_FILES['service_image']['name'])) {
        ...
        $upload_dir = $service['service_image']; // Keep the old image
    }
    ...
    if ($stmt->execute()) {
        header("Location: service.php"); // Redirect back to the services page
        exit();
    } else {
